...
public class SAMeshCollider : MonoBehaviour
{
    ...
    { get { return (meshColliderProperty != null) ? meshColliderProperty.splitProperty : null; } }
    public ReducerProperty reducerProperty
    { get { return (meshColliderProperty != null) ? meshColliderProperty.reducerProperty : null; } }
    public ColliderProperty colliderProperty
    { get { return (meshColliderProperty != null) ? meshColliderProperty.colliderProperty : null; } }
    public RigidbodyProperty rigidbodyProperty
    { get { return (meshColliderProperty != null) ? meshColliderProperty.rigidbodyProperty : null; } }

    public bool splitMaterialEnabled
    { get { return (splitProperty != null) ? splitProperty.splitMaterialEnabled : false; } }
    public bool splitPrimitiveEnabled
    { get { return (splitProperty != null) ? splitProperty.splitPrimitiveEnabled : false; } }
    public bool splitPolygonNormalEnabled
    { get { return (splitProperty != null) ? splitProperty.splitPolygonNormalEnabled : false; } }
    public float splitPolygonNormalAngle
    { get { return (splitProperty != null) ? splitProperty.splitPolygonNormalAngle : 0.0f; } }

    public bool modifyNameEnalbed
    { get { return (meshColliderProperty != null) ? meshColliderProperty.modifyNameEnabled : false; } }
