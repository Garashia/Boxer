...
Properties {
	...
	_Range				("Moving Range", Float) = 0
	_Speed				("Moving Speed", Float) = 0
}
...
SubShader {
	...
	Pass {
		...
		pixel_t VertShader(vertex_t input)
		{
            ...
            float3 scaleRotatePos = mul((float3x3)unity_ObjectToWorld, vert);
            ...
            vPosition = mul(UNITY_MATRIX_P, float4(viewPos, 1));
			vPosition.y += cos(_Time.x * _Speed) * _Range;
...
CustomEditor "TMP_SDFShaderGUI_Custom"
}
