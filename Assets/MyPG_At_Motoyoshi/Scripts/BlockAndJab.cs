...
public static class Function
{
    ...
    private static readonly PlayerState[] PLAYER_STATES_CHOICE =
    ...
    private static readonly PlayerState[] PLAYER_STATES_CHOICE_CHECK =
    new PlayerState[PLAYER_STATES_CHOICE_INDEX]
    {
...
public class BlockAndJab : PlayerStateAnimator
{
    ...
    private static readonly PlayerState[] PLAYER_STATES =
